...
namespace Bonus
{
    internal class Ex4
    {
        ...
        static void GetCheat()
        {

        }
        static void GetRogue(int numberCube,int resultCube )
        {
            int rogueRandom = rnd.Next(1, 3);
            switch (rogueRandom)
            {
                case 2:
                 resultCube = numberCube;
                    return;
                default:
                break;
            }
        ...
        static void GetCast()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                if (x < 3)
                {
                    ...
                    Console.WriteLine("Do you want to cheat?");
                    string cheat = Console.ReadLine();
                    switch (cheat)
                    {
                        case "y":
                            GetRogue(numberCube, resultCube);
                            break;
                        case "n":
                            break;
                    }
